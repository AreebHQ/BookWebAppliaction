package io.bookapplication.bookreads.search;

import io.bookapplication.bookreads.book.Book;
...
public class SearchController {
    ...
    public String getSearchResults(@RequestParam String query, Model model)
    {
       ...
       List<SearchResultBook> books = result.getDocs()
               .stream()
               .limit(10)
               .map(bookresult -> {bookresult.setKey(bookresult.getKey().replace("/works/",""));
